...
find_library(SYS_PCRE2_LIB pcre2-${PCRE2_WIDTH} PATHS /usr/lib NO_DEFAULT_PATH)
set(SYS_PCRE2_LIB "/usr/lib/libpcre2-${PCRE2_WIDTH}.a")
...
if(FISH_USE_SYSTEM_PCRE2)
    set(PCRE2_LIB "/usr/lib/libpcre2-${PCRE2_WIDTH}.a")
    set(PCRE2_INCLUDE_DIR "${SYS_PCRE2_INCLUDE_DIR}")
    message(STATUS "Using system PCRE2 library ${PCRE2_LIB}")
else()
